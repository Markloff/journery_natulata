...
import { QMBuffer, bufferToReadable, readableToBuffer, bufferToStream, streamToBuffer, newWriteableBufferStream, bufferedStreamToBuffer } from '@/core/base/common/buffer';
import { timeout } from '@/core/base/common/async';
import { peekStream } from '@/core/base/common/stream';
...
suite('Buffer', () => {
	...
	test('Performance issue with QMBuffer#slice #76076', function () { // TODO@alexdima this test seems to fail in web (https://github.com/microsoft/vscode/issues/114042)
