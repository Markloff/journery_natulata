...
import {
	...
	IDisposable,
	markAsSingleton,
	MultiDisposeError, ReferenceCollection,
	toDisposable,
} from '@/core/base/common/lifecycle';
import assert from 'assert';
import { Emitter } from '@/core/base/common/event';
import { ensureNoDisposablesAreLeakedInTestSuite, throwIfDisposablesAreLeaked } from '@/core/base/test/common/utils';
