...
import { startsWithIgnoreCase, equalsIgnoreCase, rtrim } from '@/core/base/common/strings';
import { CharCode } from '@/core/base/common/CharCode';
import { sep, posix, isAbsolute, join, normalize } from '@/core/base/common/path';
import { isNumber } from '@/core/base/common/type';
