import { IDisposable, Event, URI, Disposable } from '../../../core/base/common';
export declare const ILogService: import("../../../core/instantiation/common").ServiceIdentifier<ILogService>;
